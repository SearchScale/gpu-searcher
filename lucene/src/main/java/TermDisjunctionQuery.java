...
//  }
//
//  private BooleanQuery toBooleanQuery(Term[] terms, TermStatistics[] termStates) {
...
//    }
//
//    final BM25Similarity sim = (BM25Similarity) searcher.getSimilarity(true);
//    final TermStatistics[] termStates = new TermStatistics[terms.length];
...
//      try {
//    	  collStats = searcher.collectionStatistics(term.field());
//      } catch (IOException e) {
//    	  e.printStackTrace();
//      }
//	  TermStatistics termStats = searcher.termStatistics(new Term(term.field(), term.bytes()), new TermContext(searcher.getIndexReader().getContext()));
//	  termStates[i] = termStats;
